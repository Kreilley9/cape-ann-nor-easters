...
export default function RequestTryout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/public/request-tryout", {
        method: "POST",
        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          <div className="bg-[#121a24]/80 backdrop-blur rounded-2xl p-8 border border-[#007ba7]/30 text-center">
            ...
            <p className="text-white/70 mb-8">
              Thank you for your interest in the Cape Ann Nor'easters! We've received your tryout request and will be in touch soon.
            </p>
            <Link
              to="/"
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white mb-4" style={{ fontFamily: 'Oswald, sans-serif' }}>
            REQUEST A <span className="text-[#00c4ff]">TRYOUT</span>
          </h1>
          <p className="text-lg text-white/70 max-w-2xl">
            Join the Cape Ann Nor'easters family! Fill out the form below and we'll reach out with information about upcoming tryouts.
          </p>
        </div>
      </section>
